class GeminiDialogApp extends Application {
    ...
    activateListeners(html) {
        html.find('#send-btn').click(() => this._send(html));
        html.find('#chat-input').keypress(e => { if (e.which === 13) this._send(html); });
    }
...
window.GeminiDialogApp = GeminiDialogApp; // Global machen
